    ...
    return (
      <div className="drawer absolute left-0 z-50 w-fit">
        ...
        <div className="drawer-side  w-0 shadow-custom dark:shadow-lg">
          ...
          ></label>
          <ul className="menu  p-4 pt-14 h-[100%] min-w-[250px] max-w-[350px]  bg-white dark:bg-[#29303ea3] backdrop-blur-[8px] text-gray-500 font-inter dark:text-slate-50 md:text-[17px] text-base font-[600] relative">
            <li className="w-fit absolute top-4 right-2 z-50 text-red-500">
              <button onClick={hideDrawer} className="text-red-500 hover:scale-110 transition-transform duration-200">
